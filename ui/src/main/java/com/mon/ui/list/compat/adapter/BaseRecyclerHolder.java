...
public abstract class BaseRecyclerHolder<B extends IBaseRecyclerModel> extends RecyclerView.ViewHolder implements ILifeAttachable {
     ...
     * @param position
     */
    protected abstract void set(@NonNull final Activity act, @NonNull final BaseV2RecyclerAdapter adapter, @NonNull final B item, final int position);
     ...
     * @param position
     */
    public void outSet(@NonNull final Activity act, @NonNull final BaseV2RecyclerAdapter adapter, @NonNull final B item, final int position){
        initialize();
     ...
     * @param l
     */
    void autoSet(@NonNull final Activity act,
                 @NonNull final BaseV2RecyclerAdapter adapter,
                 @NonNull final B item, final int position,
                 @Nullable final BaseV2RecyclerAdapter.OnItemClickListener l) {
