 ...
 */
public abstract class OverlayViewSimpleList extends FrameLayout implements View_BaseAdapter.VHComponent, Handler.Callback {

    private View mRootView;
    private SwipeRecyclerView mSwipeRecyclerView;
    private ConfigOption mConfigOption;
    private View_BaseAdapter mListAdapter;
    private FrameLayout mEmptyView;
    private Handler mHandler = new Handler(this);
    private boolean mIsAutoScrollToBottomEnable;

    public OverlayViewSimpleList(@NonNull Activity context) {
        super(context);
        onCreate();
    }

    public OverlayViewSimpleList(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        onCreate();
    }
        ...
        if (mRootView == null) {
            ...
            mSwipeRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    OverlayViewSimpleList.this.onScrollStateChanged(recyclerView, newState);
                }

                @Override
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    OverlayViewSimpleList.this.onScrolled(recyclerView, dx, dy);
                }
            });
            ...
            if (!mConfigOption.isCustomSetData) {
                mListAdapter = new View_BaseAdapter(getContext(), this, mHandler);
            }
    ...
    protected void listAppend(View_IBaseModel data) {
        //Log.d("ScriptTestingService", "list-append-in");
        listUpdate(Useless.asList(data), false);
    }

    protected void listAppend(List<? extends View_IBaseModel> data) {
        listUpdate(data, false);
    }

    protected void listRefresh(List<? extends View_IBaseModel> data) {
     ...
     *
     */
    private void listUpdate(List<? extends View_IBaseModel> data, boolean clear) {
     ...
     */
    @SuppressWarnings("unused")
    protected void onInitSwipeReclcerView(SwipeRecyclerView swipeRecyclerView, View_BaseAdapter mListAdapter) {
    }

    /**
     * @param listener
     */
    public void setOnItemClickListener(View_BaseAdapter.OnItemClickListener listener) {
     ...
     * @return
     */
    public View_BaseAdapter getListAdapter() {
        return mListAdapter;
    }
    ...
    protected List<View_IBaseModel> getData(){
