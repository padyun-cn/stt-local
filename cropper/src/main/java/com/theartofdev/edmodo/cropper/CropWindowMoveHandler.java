...
final class CropWindowMoveHandler {
  ...
  public void move(
    ...
    if (mType == Type.CENTER) {
      LogUtil.d("nimada#handler", "MOVE-center::115::" + rect.toShortString());
      moveCenter(rect, adjX, adjY, bounds, viewWidth, viewHeight, snapMargin);
      LogUtil.d("nimada#handler", "MOVE-center::117::" + rect.toShortString());
    } else {
      if (fixedAspectRatio) {
        LogUtil.d("nimada#handler", "MOVE-outer-if::120::" + rect.toShortString());
        moveSizeWithFixedAspectRatio(
            rect, adjX, adjY, bounds, viewWidth, viewHeight, snapMargin, aspectRatio);
        LogUtil.d("nimada#handler", "MOVE-outer-if::123::" + rect.toShortString());
      } else {
        LogUtil.d("nimada#handler", "MOVE-outer-else::125::" + rect.toShortString());
        moveSizeWithFreeAspectRatio(rect, adjX, adjY, bounds, viewWidth, viewHeight, snapMargin);
        LogUtil.d("nimada#handler", "MOVE-outer-else::127::" + rect.toShortString());
      }
    }
  }
  ...
  private void moveCenter(
    ...
    LogUtil.d("nimada#handler", "MOVE-offset::209::" + rect.toShortString());
    rect.offset(dx, dy);
    LogUtil.d("nimada#handler", "MOVE-offset::211::" + rect.toShortString());
