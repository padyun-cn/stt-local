...
//    borderCornerLength = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 14, dm);
    borderCornerLength = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, dm);
...
//    maxCropResultHeight = 99999;
    minCropWindowWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 6, dm);
    minCropWindowHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 6, dm);
    minCropResultWidth = 4;
    minCropResultHeight = 4;
    maxCropResultWidth = 99999;
    maxCropResultHeight = 99999;
