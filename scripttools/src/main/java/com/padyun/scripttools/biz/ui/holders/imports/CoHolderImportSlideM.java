 ...
 */
public class CoHolderImportSlideM extends AbsCoHolderImport<CoImportSlide> {
    ...
    public CoHolderImportSlideM(@NonNull View itemView) {
        super(itemView);
    }
    ...
    protected void onSet(@NonNull Activity act, @NonNull BaseV2RecyclerAdapter adapter, @NonNull CoImportSlide item, int position) {
        ...
        if(data != null) {
            ...
            loadIdentifyImage(item, data.getIdentifyImage().getImageCropPath(), mImgTarget);
