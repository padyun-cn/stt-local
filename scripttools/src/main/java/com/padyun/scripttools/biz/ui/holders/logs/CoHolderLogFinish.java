 ...
 */
public class CoHolderLogFinish extends AbsCoHolder<CoLogItem<CoFinish>> {
    private ImageView img;
    private TextView label, actionName;
    public CoHolderLogFinish(@NonNull View itemView) {
        super(itemView);
    }
    ...
    @Override
    protected void onSet(@NonNull Activity act, @NonNull BaseV2RecyclerAdapter adapter, @NonNull CoLogItem<CoFinish> item, int position) {
